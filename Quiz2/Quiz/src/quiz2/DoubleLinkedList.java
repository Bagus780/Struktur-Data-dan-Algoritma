...
public class DoubleLinkedList {
    ...
    public void addFirst(Mahasiswa data) {
        if (isEmpty()) {
            head = new Node4(null, data, null);
        } else {
            Node4 newNode = new Node4(null, data, head);
            head.prev = newNode;
            head = newNode;
        }
        size++;
    ...
    public void addLast(Mahasiswa data) {
        if (isEmpty()) {
            ...
            current.next = new Node4(current, data, null);
            size++;
        }
    }
    ...
    public void add(Mahasiswa data, int idx) throws Exception {
        if (isEmpty()) {
            ...
            if (current.prev == null) {
                Node4 newNode = new Node4(null, data, current);
                current.prev = newNode;
                head = newNode;
            } else {
                Node4 newNode = new Node4(current.prev, data, current);
