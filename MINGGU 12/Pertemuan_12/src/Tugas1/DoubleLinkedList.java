...
public class DoubleLinkedList {
    ...
    public void add(int item, int index) throws Exception {
        if (isEmpty()) {
            ...
            throw new Exception("Nilai Indeks di Luas Batas");
        } else {
            Node current = head;
            int i = 0;
            while (i < index) {
    ...
    public void sort() {
        ...
        if (head == null) {
            ...
            for (current = head; current.next != null; current = (Node) current.next) {
                for (index = (Node) current.next; index != null; index = index.next) {
